...
if __name__ == '__main__':
    pred = np.load('../model/data/bike/20230129020945/pred.npy')
    true = np.load('../model/data/bike/20230129020945/true.npy')
    mae, rmse, mape, rrse, corr = All_Metrics(pred, true, False, 0.)
    print(mae, rmse, mape)
